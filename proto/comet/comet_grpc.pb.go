...
const (
	...
	Comet_SendMsgBatch_FullMethodName = "/lane.comet.comet/SendMsgBatch"
)
...
func (c *cometClient) SendMsgBatch(ctx context.Context, in *msg.SendMsgBatchReq, opts ...grpc.CallOption) (*NoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NoResp)
	err := c.cc.Invoke(ctx, Comet_SendMsgBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCometServer) SendMsgBatch(context.Context, *msg.SendMsgBatchReq) (*NoResp, error) {
...
func _Comet_SendMsgBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(msg.SendMsgBatchReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CometServer).SendMsgBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Comet_SendMsgBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CometServer).SendMsgBatch(ctx, req.(*msg.SendMsgBatchReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Comet_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Comet_SendMsgBatch_Handler,
		},
	},
