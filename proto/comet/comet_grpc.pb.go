...
const (
	...
	Comet_RoomBatch_FullMethodName = "/lane.comet.comet/RoomBatch"
)
...
type CometClient interface {
	...
	RoomBatch(ctx context.Context, in *RoomBatchReq, opts ...grpc.CallOption) (*NoResp, error)
}
...
func (c *cometClient) RoomBatch(ctx context.Context, in *RoomBatchReq, opts ...grpc.CallOption) (*NoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NoResp)
	err := c.cc.Invoke(ctx, Comet_RoomBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CometServer interface {
	...
	// rpc Room(RoomReq) returns (NoResp);
	RoomBatch(context.Context, *RoomBatchReq) (*NoResp, error)
}
...
func (UnimplementedCometServer) RoomBatch(context.Context, *RoomBatchReq) (*NoResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RoomBatch not implemented")
}
...
func _Comet_RoomBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RoomBatchReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CometServer).RoomBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Comet_RoomBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CometServer).RoomBatch(ctx, req.(*RoomBatchReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Comet_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RoomBatch",
			Handler:    _Comet_RoomBatch_Handler,
		},
	},
