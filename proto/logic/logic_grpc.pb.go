...
type LogicClient interface {
	...
	SendMsgBatch(ctx context.Context, in *SendMsgBatchReq, opts ...grpc.CallOption) (*NoResp, error)
...
func (c *logicClient) SendMsgBatch(ctx context.Context, in *SendMsgBatchReq, opts ...grpc.CallOption) (*NoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NoResp)
...
type LogicServer interface {
	...
	SendMsgBatch(context.Context, *SendMsgBatchReq) (*NoResp, error)
...
func (UnimplementedLogicServer) SendMsgBatch(context.Context, *SendMsgBatchReq) (*NoResp, error) {
...
func _Logic_SendMsgBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicServer).SendMsgBatch(ctx, req.(*SendMsgBatchReq))
	}
	return interceptor(ctx, in, info, handler)
}
